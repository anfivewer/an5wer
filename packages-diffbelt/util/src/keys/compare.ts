...
export const isLessThan = (a: EncodedKey, b: EncodedKey) => {
  if (a.keyEncoding === b.keyEncoding) {
    return a.key < b.key;
  }

  const aBase64 = a.keyEncoding === 'base64' ? a.key : toBase64(a.key);
  const bBase64 = b.keyEncoding === 'base64' ? b.key : toBase64(b.key);
