...
type MyEvent = Omit<CarEvent, 'id'> & {index?: number} & (
    | {date: string}
    | {creationDate: string}
    | {type: typeof CarEventType.planned}
  );
